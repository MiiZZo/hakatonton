  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <FormControl isRequired>
        ...
        <Input name="firstName" placeholder="Text" w="80%" m="0 auto" ref={register({ required: true, minLength: 2 })}/>
      </FormControl>
      <FormControl isRequired>
        <FormLabel m="20px 50px 10px 50px" color="#000000" fontWeight="550" >
          Фамилия
        </FormLabel>
        <Input name="lastName" placeholder="Text" w="80%" m="0 auto" ref={register({ required: true, minLength: 2 })}/>
      </FormControl>
      <FormControl isRequired>
        <FormLabel m="20px 50px 10px 50px" color="#000000" fontWeight="550">
          E-mail
      ...
      <FormControl isRequired>
        ...
        <Input type="password" placeholder="Text" w="80%" m="0 auto" name="password" ref={register({ required: true, minLength: 8 })}/>
      </FormControl>
      <FormControl isRequired>
        <FormLabel m="20px 50px 10px 50px" color="#000000" fontWeight="550">
          Телефон
